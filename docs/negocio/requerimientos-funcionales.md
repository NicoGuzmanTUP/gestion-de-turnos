...
Ver dashboard de su propio negocio (turnos de hoy, próximos turnos, % de ocupación).
...
Recibir notificación (WhatsApp, con mail como fallback) ante confirmación, cancelación o reprogramación de sus turnos.
Sistema
